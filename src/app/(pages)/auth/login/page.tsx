...
function LoginContent() {
      ...
      if (error instanceof LoginApiError && error.statusCode === 404) {
        toast.error(
          <span>
            ...
            <Link href="/auth/signup" className="underline" style={{ color: t.gold }}>
              Sign up instead
            </Link>
          </span>
        );
  ...
  const canSubmit = !isLoading && !isRedirecting;
    ...
    <div className="min-h-screen h-screen flex relative overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-9 relative z-10">
        ...
        >
          ...
          <div className="mb-4">
            <p style={{ fontFamily: "var(--font-body)", fontSize: 12, color: t.fgMid, marginBottom: 8 }}>Login with:</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div className="text-right">
              <Link
                ...
                style={{ fontFamily: "var(--font-body)", fontSize: 12, fontWeight: 500, color: t.gold, transition: "opacity 0.2s" }}
              >
                Forgot password?
              </Link>
            </div>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 10,
                border: "none",
                color: canSubmit ? t.ctaFg : t.fgFaint,
                background: canSubmit ? t.ctaBg : t.progressTrack,
